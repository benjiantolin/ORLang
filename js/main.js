...
function highlightFeature(e) {
  ...
  $(".update").html(
    ...
    (layer.feature.properties.shareLep).toFixed(2) + '% of the population 5 years and over in limited English speaking households<br>');

}
// 3.2.3 reset the hightlighted feature when the mouse is out of its region.
function resetHighlight(e) {
  county.resetStyle(e.target);
  $(".update").html("<b>Oregon</b><br>2.9% of the population 5 years and over in limited English speaking households");
}
